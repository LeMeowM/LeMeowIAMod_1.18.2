...
public class ModSerializer<InfusionTableRecipe extends AbstractCookingRecipe> implements RecipeSerializer<InfusionTableRecipe> {
    ...
    public InfusionTableRecipe read(Identifier id, JsonObject jsonObject) {
        ...
        return this.recipeFactory.create(id, string, ingredient, itemStack, f, i);
    }
    ...
    interface RecipeFactory<InfusionTableRecipe extends AbstractCookingRecipe> {
        InfusionTableRecipe create(Identifier id, String group, Ingredient input, ItemStack output, float experience, int cookTime);
    }
}
