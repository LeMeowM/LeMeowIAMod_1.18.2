package net.lemeow.iamod.world.generator;

import net.lemeow.iamod.config.Configs;
import net.minecraft.util.math.BlockPos;
import net.minecraft.util.math.MathHelper;

public class EndGeneratorOptions {
    ...
    public static EndLayerOptions bigOptions;
    public static EndLayerOptions mediumOptions;
    public static EndLayerOptions smallOptions;
    ...
    public static void init() {
        ...
        bigOptions = new EndLayerOptions(
        ...
        mediumOptions = new EndLayerOptions(
        ...
        smallOptions = new EndLayerOptions(
