...
public class EndLayerOptions {
    ...
    public EndLayerOptions(String name, PathConfig config, float distance, float scale, int center, int heightVariation, boolean hasCentral) {
