...
package net.lemeow.iamod.world.gen;
...
import net.lemeow.iamod.world.biome.ModEndFeatures;
import net.lemeow.iamod.world.biome.ModEndTags;
...
public class ModBiomeGeneration extends BCLBiome implements SurfaceMaterialProvider {
    public static final RegistryKey<Biome> END_FOREST = RegistryKey.of(Registry.BIOME_KEY, new Identifier(IAMod.MOD_ID, "end_forest"));
    ...
    public static abstract class Config{
        ...
        protected Config(String name) {
            this.ID = new Identifier(IAMod.MOD_ID, name);
        }
